...
// Keep a broader network guard without locking out a whole staff after five typos.
export const dashboardLoginNetworkThrottle = createLoginThrottle({ maxFailures: 50 });
