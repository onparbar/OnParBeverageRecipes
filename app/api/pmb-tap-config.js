...
function httpRequest(config, method, requestPath, body = "", headers = {}) {
...
async function getDigestPage(config, requestPath, { cookieJar = new Map() } = {}) {
...
export async function getTapConfigRows(config) {
