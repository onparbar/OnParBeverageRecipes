...
export const LOCAL_AI_COLUMNS = {
  ...
  levels: ["name", "tapNumber", "wall", "fraction", "ounces", "firstRecordedPourAt", "firstPourHistoryScope", "firstPourSearchedThrough", "firstPourHasCoverageGaps", "productChangedAt", "productChangeSource", "previousProduct"],
