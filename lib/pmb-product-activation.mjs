...
export async function activateQueuedPmbProducts({
  ...
  try {
    ...
    await recordActivity({
      ...
      summary: `${summary.checked} On Deck/Coming Soon products verified active; ${summary.activated.length} activated; ${summary.issues.length} product issues retained for review.`,
    }).catch(() => {});
    return summary;
  } catch (error) {
