...
const COCKTAIL_RECIPE_YIELD_OZ = {
  "spiked-arnold-palmer": 1507,
  "spiked-cranberry-lemonade": 1379,
  "spiked-pink-lemonade": 1379,
  "spiked-strawberry-lemonade": 1379,
};
...
export function getCocktailRecipeYieldOz(item) {
  ...
  const normalizedName = normalizeName(item?.name || item?.brand || "", { stripWallNumber: true });
  return COCKTAIL_RECIPE_YIELD_OZ[slugify(normalizedName)] || 0;
}
...
export function buildRawRecommendation(tap, level, weeklyEntries, state, settings) {
